...
- [ ] Tested against a Humanoid avatar — including any heuristic-tuning changes against a known-good and known-bad mesh.
...
## Avatar tested against
<!-- Brief description: humanoid? prop bones? mesh count? Helps with reproducibility. -->
